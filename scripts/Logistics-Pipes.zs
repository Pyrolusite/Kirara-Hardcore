...
val FineWireBundle = <ore:wireFineTitanium>;
...
[AdvCircuit, BasicLPipe, AdvCircuit]]);

// --- Logistics Fuzzy Crafting Table
recipes.addShaped(LFuzzyCraftingT, [
[Screwdriver, SteelScrew, null],
[BasicCircuit, LCraftingT, BasicCircuit],
...
[GoldGear, IronTransportPipe, GoldGear],
[DiamondRod, GoldChip, DiamondRod]]);
